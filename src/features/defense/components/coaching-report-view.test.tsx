...
const report: CoachingReport = {
  ...
  drills: ['Explain why.'],
  metrics: { paceWpm: 142, fillerPerMin: 6, verbatimSlides: 2, slideTimes: [{ slideIndex: 1, ms: 60000, atMs: 0 }], questionsHandled: { handled: 3, total: 5 }, deckless: false, delivery: null },
